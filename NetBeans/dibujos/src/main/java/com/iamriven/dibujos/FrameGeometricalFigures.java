 ...
 * @author Alumnado
 */
public class FrameGeometricalFigures extends javax.swing.JFrame {

    /**
     * Creates new form FrameGeometricalFigures
     */
    ArrayList<Drawable> figures= new ArrayList<>();
    public FrameGeometricalFigures() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonI.setFont(new java.awt.Font("Segoe Script", 0, 18)); // NOI18N
        jButtonI.setText("<<");
        ...
        jButtonD.setFont(new java.awt.Font("Segoe Script", 0, 18)); // NOI18N
        jButtonD.setText(">>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameGeometricalFigures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameGeometricalFigures().setVisible(true);
            }
        });
    }
