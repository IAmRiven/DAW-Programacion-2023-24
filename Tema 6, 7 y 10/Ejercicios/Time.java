...
public class Time {
    ...
    public String toString() {
        return "Time [horas=" + horas + ", minutos=" + minutos + ", segundos=" + segundos + "]";
    }
    ...
    public static void main(String[] args) {
        Time tiempo_1 = new Time(204569);
        System.out.println(tiempo_1);
    }

}

// Create a method that converts a number of seconds to hour, minutes and
// seconds.
// For example:
...
// Take the object returned by the method and print it on screen (you would have
