public class OpositorA extends Opositor {
    private double puntuacion;

    public OpositorA(String nombre_completo, int edad, String dni, int experiencia, int oposiciones_aprobadas,
            double nota_examen) {
    ...
    public void print() {
        System.out
                .println("Opositor[A]: " + getNombre_completo() + ", Edad: " + getEdad() + ", DNI: " + getDni()
    ...
    public double CalcularPuntuacion() {
        int opo_aprobadas = this.getOposiciones_aprobadas() * 3;
        int anyo_exp = this.getExperiencia() * 2;
